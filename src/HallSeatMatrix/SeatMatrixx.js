    ...
    <div className="seatmatrixbody">
      <div className="movie_desc_bar">
        <div className="movie_desc_bar-Left">
          ...
          <input style={{borderRadius: "10px", display:"flex", textAlign:"center"}}
             onChange={(e)=>{setTotalSeats(e.target.value)}} defaultValue={totalSeats}
        type="number" placeholder="Please enter the seats"></input>
    
<Button   onClick={()=>{SetConfirmSeats()}}>Save</Button>
